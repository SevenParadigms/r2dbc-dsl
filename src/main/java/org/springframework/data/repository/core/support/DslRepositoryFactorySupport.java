 ...
 * @author John Blum
 */
public abstract class DslRepositoryFactorySupport implements BeanClassLoaderAware, BeanFactoryAware {

    final static GenericConversionService CONVERSION_SERVICE = new DefaultConversionService();
    private static final Log logger = LogFactory.getLog(DslRepositoryFactorySupport.class);
    ...
    public DslRepositoryFactorySupport() {
