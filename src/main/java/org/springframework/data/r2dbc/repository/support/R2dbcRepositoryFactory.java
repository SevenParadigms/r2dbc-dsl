...
public class R2dbcRepositoryFactory extends ReactiveRepositoryFactorySupport {
	 ...
	 * @since 1.1.3
	 */
	public R2dbcRepositoryFactory(R2dbcEntityOperations operations, ApplicationContext applicationContext) {
	...
	protected Object getTargetRepository(RepositoryInformation information) {
		...
		return getTargetRepositoryViaReflection(information, entityInformation, operations, converter, applicationContext);
	}
