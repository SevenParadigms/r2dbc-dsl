...
* On field with name `version` do not required @Version annotation if it have type `Long`, `Integer`, `Short`, `ZonedDateTime` or `LocalDateTime` for optimistic locking
