...
R2DBC-DSL contains the current version of the Spring Data R2dbc, and each commit to the master of Spring Data R2dbc repository is immediately published there under the new subversion into Maven Central, i.e. all changes in the Spring Data R2dbc master are realtime relevant here.
